...
<header class="py-5 bg-light border-bottom mb-4">
    <div class="container">
        ...
        <div class="col-lg-8">
            ...
            <!-- Featured blog post-->
            <div class="card mb-4">
                <a href="#!"><img class="card-img-top" src="{{URL::to('public/assets/images/'.$item->img_link.'')}}" alt="..." /></a>
                <div class="card-body">
         ...
         @endforeach
             ...
             <!-- Featured blog post-->
                 <div class="card mb-4">
                     <a href="#!"><img class="card-img-top" src="{{url('assets/images/'.$item->img_link.'')}}" alt="..." /></a>
                     <a href="#!"><img class="card-img-top" src="'../public/assets/images/{{$item->img_link}}" alt="..." /></a>
                         <div class="card-body">
                            <div class="text-muted fst-italic mb-2">
                                {{$mysqldate = date('g:i a \o\n l jS F Y', strtotime($item->created_at))}}
                                </div>
